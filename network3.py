...
networks.
In particular, the API is similar to network2.
...
def load_data_shared(filename ='C:/Users/ckratochvil/AppData/Local/Continuum/Anaconda3/mnist.pkl.gz'):
    ...
    f.close()
    def shared(data):
        """ Place the data into shared variables. This allows Theano
        to copy the data to the GPU, if one is availabel :DD
        """
...
class Network(object):
    ...
    def __init__(self, layers, mini_batch_size):
        ...
        a value for the 'mini_batch_size' to be used during training by sgd
        """
        self.layers = layers
...
class ConvPoolLayer(object):
    """ Used to create a combination of a convulutional and a max-pooling layer """
    ...
    def set_inpt(self, inpt, input_dropout, mini_batch_size):
        ...
        self.output_dropout = self.output # no dropout in the convulutional layers
